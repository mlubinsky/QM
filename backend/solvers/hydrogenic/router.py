...
from .orbitals import xz_cross_section, spherical_harmonic_polar, orbital_isosurface
...
def solve_hydrogenic(req: HydrogenicRequest) -> HydrogenicResponse:
    ...
    # 2-D cross-section, spherical harmonic polar curve, 3-D isosurface
    orbital = xz_cross_section(radial.r, u, req.l, req.m, req.grid_2d_points)
    sph_polar = spherical_harmonic_polar(req.l, req.m)
    iso_axis, iso_values = orbital_isosurface(req.n, req.l, req.m, req.Z)
