"""FastAPI router for the 1-D Schrödinger solver.

Mounts at prefix /schrodinger1d in app.py.
...
@router.post("/solve/eigenstates", response_model=EigensolveResponse)
...
@router.post("/solve/evolve", response_model=EvolveResponse)
